...
class DonationController extends Controller
{
    ...
    public function index()
    {
        ...
        $params     = ['data' => $donations];

        return view('admin.donation', $params);
    }
